            ...
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    ...
                    <div class="px-6 py-4 flex">
                        <input type="search" class="form-input flex-1 shadow-sm border-gray-300 rounded mr-4" placeholder="Buscar curso" wire:model="search" wire:keydown="clearPage">
                        <a class="btn btn-primary" href="{{route('teacher.courses.create')}}">Crear nuevo curso</a>
                    </div>
                    @if ($courses->count()>0)
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            @isset($course->image)
                                            <img class="h-10 w-10 rounded object-cover object-center" src="{{Storage::url($course->image->url)}}" alt="{{$course->title}}">
                                            @else
                                            <img class="h-10 w-10 rounded object-cover object-center" src="{{asset('img/page/courses/course-default.jpg')}}" alt="{{$course->title}}">
                                            @endisset
                                        </div>
                                        <div class="ml-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{$course->students->count()}} Alumnos</div>
                                    <div class="text-sm text-gray-500">Matrículados</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-500">{{$course->rating}} Estrellas</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <div class="alert flex flex-row items-center bg-blue-200 p-5 rounded border-b-2 border-blue-300">
                            ...
                            <div class="alert-content ml-4">
                                ...
                                <div class="alert-description text-sm text-blue-600">
                                    No hay ningun curso coincidente con el texto ingresado
                                </div>
                            </div>
                        </div>
                    </div>
